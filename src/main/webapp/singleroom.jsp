...
<script>
    ...
    <div class="main">
        <div class="wrapper">
            <!-- 当前位置 -->
            <div class="cur-pos"><a target="_blank" href="">首页</a> &gt; <a target="_blank" href="">单间</a></div>
            <!-- End当前位置 -->
			            <!-- 过滤表单 -->
			                <div class="switcher">
				                      ...
				                      <!--   <div class="form-group">
				                       ...
				                       <div class="form-group">
				                        ...
				                        <div class="form-group">
				                            ...
				                            <a href="#" onclick="commitform();" class="option-link1 curr"><label class="label">单间</label></a>
