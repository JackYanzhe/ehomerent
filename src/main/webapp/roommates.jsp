...
<script>
    ...
    <div class="main">
        <div class="wrapper">
            <!-- 当前位置 -->
            <div class="cur-pos"><a target="_blank" href="">首页</a> &gt; <a target="_blank" href="">合租</a></div>
            <!-- End当前位置 -->
			            <!-- 过滤表单 -->
			                <div class="switcher">
				                       ...
				                       <div class="form-group">
				                        ...
				                        <div class="form-group">
				                            <span class="fg-title">租住类型:</span>
				                            				       <!--  curr -->                     				                            
				                            <a href="#" onclick="commitform();" class="option-link1"><label class="label">不限</label></a>
				                            <a href="##" onclick="commitform();" class="option-link1"><label class="label">整租</label></a>
				                            <a href="##" onclick="commitform();" class="option-link1 curr"><label class="label">合租</label></a>
