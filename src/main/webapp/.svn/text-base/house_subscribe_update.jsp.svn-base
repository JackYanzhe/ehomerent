   ...
   <script type="text/javascript">
     ...
     $(function(){
        ...
        $.getJSON("subscribe/getAreaJson2",function(result){ 
            ...
            /* 修改用户信息操作 */
            var subscribeCircletime= $("#subscribeCircletime").val();
            var subscribeRenttype= $("#subscribeRenttype").val();
            var subscribeHousetype= $("#subscribeHousetype").val();
            //alert(subscribeCircletime+","+subscribeRenttype+","+subscribeHousetype);
            
           /*  $(".ctopt").attr(); */
            
            if(subscribeCircletime=="不限"){
               $("#ctopt0").attr("selected","selected");
            }
            if(subscribeCircletime=="年租"){
               $("#ctopt0").removeAttr("selected");
               $("#ctopt1").attr("selected","selected");
            }
            if(subscribeCircletime=="月租"){
               $("#ctopt0").removeAttr("selected");
               $("#ctopt2").attr("selected","selected");
            
            }
            
            /* 租住类型 */
            if(subscribeRenttype==0){
               $("#rtopt0").attr("selected","selected");
            }
            if(subscribeRenttype=="整租"){
               $("#rtopt0").removeAttr("selected");
               $("#rtopt1").attr("selected","selected");
            }
            if(subscribeRenttype=="分租"){
               $("#rtopt0").removeAttr("selected");
               $("#rtopt2").attr("selected","selected");
            
            }
             if(subscribeRenttype=="单间"){
               $("#rtopt0").removeAttr("selected");
               $("#rtopt3").attr("selected","selected");
            }
            if(subscribeRenttype=="床位"){
               $("#rtopt0").removeAttr("selected");
               $("#rtopt4").attr("selected","selected");
            }
            /* 房屋户型 */
            if(subscribeHousetype=="不限"){
               $("#htopt0").attr("selected","selected");
            }
            if(subscribeHousetype=="一室"){
               $("#htopt0").removeAttr("selected");
               $("#htopt1").attr("selected","selected");
            }
            if(subscribeHousetype=="二室"){
               $("#htopt0").removeAttr("selected");
               $("#htopt2").attr("selected","selected");
            
            }
             if(subscribeHousetype=="三室"){
                $("#htopt0").removeAttr("selected");
               $("#htopt3").attr("selected","selected");
            
            }
             if(subscribeHousetype=="三室以上"){
               $("#htopt0").removeAttr("selected");
               $("#htopt4").attr("selected","selected");
			         ...
			         <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <!-- <input type="password" class="form-control" id="inputPassword3" placeholder="Password"> -->
					       <div class="sublength">
							  <input type="text" name="subarealocalinfo" value="${subscribe.subarealocalinfo}" id="areaInfomg" class="sublength btn btn-default btn-sm dropdown-toggle"  data-toggle="modal" data-target="#myModal_area">
							  </input>
							</div>
					    </div>
					  </div>
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <input type="text" name="rentmoneymin" value="${subscribe.rentmoneymin}" class="formwid form-control"  placeholder="区间上限"> ----
					      <input type="text" name="rentmoneymax" value="${subscribe.rentmoneymax}" class="formwid form-control"  placeholder="区间下限">
					    </div>
					  </div>
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <!-- <input type="password" class="form-control" id="inputPassword3" placeholder="Password"> -->
					       <div class="sublength">
					          ...
					          <input type="hidden" id="subscribeCircletime" value="${subscribe.circletime}">
					          <input type="hidden" id="subscribeRenttype" value="${subscribe.renttype}">
					          <input type="hidden" id="subscribeHousetype" value="${subscribe.housetype}">
					          
							  <select name="circletime" class="sublength2" >
							             <option id="ctopt0" value="不限" selected="selected">不限</option>
								         <option id="ctopt1" value="年租">年租</option>
								         <option id="ctopt2" value="月租">月租</option>    
							  </select>
							</div>
					    </div>
					  </div>
					      ...
					      <!-- <input type="password" class="form-control" id="inputPassword3" placeholder="Password"> -->
					       <div class="sublength">
							 <select name="renttype" class="sublength2" >
							         ...
							         <option  id="rtopt0" value="不限" selected="selected">不限</option>
							         <option  id="rtopt1" value="整租">整租</option>
							         <option  id="rtopt2" value="分租">分租</option>
							         <option  id="rtopt3" value="单间">单间</option>
							         <option  id="rtopt4" value="床位">床位</option>
					      ...
					      <!-- <input type="password" class="form-control" id="inputPassword3" placeholder="Password"> -->
					       <div class="sublength">
							  <select name="housetype" class="sublength2" >
							        ...
							        <option id="htopt0" value="不限" selected="selected">不限</option>
							         <option id="htopt1" value="一室">一室</option>
							         <option id="htopt2" value="二室">二室</option>
							         <option id="htopt3" value="三室">三室</option>
							         <option id="htopt4" value="三室以上">三室以上</option>
