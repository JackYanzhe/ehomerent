...
<script>
    ...
    <div class="main">
        <div class="wrapper">
            <!-- 当前位置 -->
            <div class="cur-pos"><a target="_blank" href="">首页</a> &gt; <a target="_blank" href="">纯月租</a></div>
            <!-- End当前位置 -->
			            <!-- 过滤表单 -->
			                <div class="switcher">
				                      ...
				                      <!--   <div class="form-group">
				                       ...
				                       <div class="form-group">
				                            <span class="fg-title">租住时间:</span>
				                   	        <a href="#" onclick="commitform();" class="option-link0"><label onclick="commitform();" class="label">不限</label></a>
				                            <a href="#" onclick="commitform();" class="option-link0"><label class="label">年租</label></a>
				                            <a href="#" onclick="commitform();" class="option-link0 curr"><label class="label">纯月租</label></a>
           ...
           <div id="page">
             ...
             <!--   <ul class="pagination">     -->
               <%--    <input type="hidden" id="" value="">  
                  <a href="/ServletTestELs/UserMsg?pagenow=1"><span class="page-nav">首页</span></a>                                                
                  <a href="/ServletTestELs/UserMsg?pagenow=${ulist.lastpage}"><span class="page-nav">&laquo;</span></a>
                  <a href="/ServletTestELs/UserMsg?pagenow=${i}"><span class="page-nav">${i}</span></a>
                  <a href="/ServletTestELs/UserMsg?pagenow=${ulist.nextpage}"><span class="page-nav">&raquo;</span></a>
                  <a href="/ServletTestELs/UserMsg?pagenow=${ulist.totlepage}"><span class="page-nav">尾页</span></a> --%>
				<!--     
                    </ul> -->
               <ul class="pagination">
